...
if is_training:
    ...
    for epoch in range(1, maxepoch):
        ...
        for id in np.random.permutation(len(syn_image1_list)): ##############################################################################################################
            st = time.time()
...
# To test the model on images with reflection
    ...
    test_path = ["./test_images/testdata_reflection_synthetic_table2/blended/"]
    subtask = "synthetic_table2"  # if you want to save different testset separately
